  ...
  return (
      ...
      <View className="flex-1 px-2 pt-10">
        <View className="flex-row items-center gap-3 mt-2">
          ...
          <SafeText style={{fontFamily: 'ShareTech_400Regular'}} className="text-[17px] text-white">Privacy & data</SafeText>
          <View className="w-10" />
        </View>

        <ScrollView className="mt-3" contentContainerClassName="pb-28">
          <Card accent="blue" className="px-2 py-3">
            <SafeText style={{fontFamily: 'ShareTech_400Regular'}} className="text-[14px] text-white">What TICS stores</SafeText>
            <SafeText style={{fontFamily: 'ShareTech_400Regular'}} className="mt-3 text-[13px] leading-5 text-slate-400">
          ...
          <Card className="px-2 py-3">
            <SafeText style={{fontFamily: 'ShareTech_400Regular'}} className="text-[14px] text-white">Your controls</SafeText>
            <SafeText style={{fontFamily: 'ShareTech_400Regular'}} className="mt-3 text-[13px] leading-5 text-slate-400">
