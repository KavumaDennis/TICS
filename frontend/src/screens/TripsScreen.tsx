    ...
    return (
      <View className="flex-1 p-1">
        ...
        >
          ...
          <SafeText style={{ fontFamily: 'ShareTech_400Regular' }} className="text-tics-text text-[17px]">My Trips</SafeText>
        </View>

        <Card accent="blue" className="py-6">
          <SafeText style={{ fontFamily: 'ShareTech_400Regular' }} className="text-tics-amber ml-2  text-[20px]">Sign in required</SafeText>
          <SafeText style={{ fontFamily: 'ShareTech_400Regular' }} className="mt-2 ml-2  text-tics-muted text-[12px] leading-5">Create and manage trips after signing in.</SafeText>
          ...
          <View className="mt-5 flex-row gap-3">
            <Pressable onPress={() => router.push('/auth/login')} className="flex-1 rounded-full bg-tics-amber/35 border border-tics-amber/20 p-6">
              <SafeText style={{ fontFamily: 'ShareTech_400Regular' }} className="text-center text-[13px] text-tics-text">Login</SafeText>
            </Pressable>
            <Pressable
  ...
  return (
    <View className="flex-1 p-1">
      <View className="p-2 flex-row items-center justify-between gap-3 bg-tics-amber/25 border border-tics-amber/10 rounded-full mb-3">
        <SafeText style={{ fontFamily: 'ShareTech_400Regular' }} className="text-tics-text text-[17px] ml-2">My Trips</SafeText>
        <Pressable onPress={() => router.push('/trip/add' as any)} className="bg-tics-amber/35 border border-tics-amber/20 px-5 py-4 rounded-full">
          <SafeText style={{ fontFamily: 'ShareTech_400Regular' }} className="text-[12px] text-tics-text">+ New Trip</SafeText>
        </Pressable>
      </View>

      {/* Search bar */}
      <View className="mt-1 flex-row items-center gap-2 rounded-full border border-tics-amber/50 bg-white/[0.05] px-3 py-2">
        <Ionicons name="search-outline" size={16} color="rgba(248,250,252,0.4)" />
        <TextInput
          style={{ fontFamily: 'ShareTech_400Regular', flex: 1, color: 'rgba(248,250,252,0.9)', fontSize: 13 }}
          value={search}
      ...
      <FlatList
                ...
                <View className="flex-row items-center justify-between">
                  ...
                  <View className="flex-row items-center gap-2">
                    <Pressable
                      ...
                      className="bg-tics-red/30 border border-tics-red/10 rounded-xl px-3 py-1"
                    >
                      <SafeText style={{ fontFamily: 'ShareTech_400Regular' }} className="text-tics-red text-[11px]">
                        Delete all
                      </SafeText>
                    </Pressable>
        ...
        ListEmptyComponent={
          <View className="pt-10">
            <SafeText style={{ fontFamily: 'ShareTech_400Regular' }} className="text-tics-muted text-[13px]">
